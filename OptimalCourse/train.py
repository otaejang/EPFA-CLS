...
if __name__ == '__main__':
    ...
    path_model = os.path.join(args.saved_path, f'jotNet_DV_{save_time}.pth')
    path_file_load_in = "./data/labdata_x.csv"
    path_file_load_out = "./data/labdata_y.csv"
    path_file_save = "./data/pred_y.csv"
